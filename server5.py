...
while True:
	...
	if socket_clients in socks and socks[socket_clients] == zmq.POLLIN:
		...
		if action=="connect":
			...
			dic={"username":username,"direc":0,"posx":pos_init_x,"posy":pos_init_y,"fondo":fondo,"personaje":personaje,"vida":100,"mana":100}
		...
		if action=="move" or action=="golpe" or action=="stop" or action =="mapeo" or action == "dano" or action=="dead" or action=="transformar":
			...
			if action=="dano":
				players[nombre].dic["vida"]=dic1["vida"]	
